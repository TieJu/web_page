...
class BbcodeHelper extends ShortcodeHelper {
    ...
    function __construct(){
        ...
        $this->add_shortcode(array(
            ...
            array('s', array(&$this, 'onStrikethrough')),
            //size
            //color
            //ceneter
    ...
    function onStrikethrough( $atts = array(), $content = null ) {
      return '<span style="text-decoration:line-through">' . $this->do_shortcode( $content ) . '</span>';
    }
    ...
    public function translate($c_) {
      return $this->doShortcode($c_);
    }

    public function toHtml($bb_code_ ) {
      return $this->doShortcode($bb_code_);
    }
